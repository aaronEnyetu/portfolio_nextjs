...
const Hero = () => {
  ...
  const handleSocialClick = (info: SocialMediaItem) => {
    if (info.action === "copy") {
      navigator.clipboard.writeText("aaronenyetu@gmail.com").then(() => {
  ...
  const handleDownloadCV = () => {
    ...
    link.download = "Aaron Enyetu_Resume.pdf";
      ...
      <div className="flex justify-center relative my-1 z-10">
        <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
          ...
          <p className="text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl">
            Hi! I&apos;m a Software Engineer focused on developing immersive and
