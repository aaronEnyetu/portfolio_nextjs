    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4 text-2xl">
        ...
        <Card
          ...
          des=" I am passionate about collaborating and continuously improving to tackle challenges. With a focus on ethical technology, I apply thoughtful principles to design innovations that benefit society. My interests span software development, AI, machine learning, game development, character animation, and 3D development, all aimed at creating interactive content and visual effects. What excites me most is solving real-world problems and helping others. I take great pride in overcoming challenges and seeing the tangible results of my work, knowing that my solutions make a positive impact. "
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card
          ...
          des="One of my greatest strengths is my continuous curiosity and drive to learn, which has shaped my career and professional growth. From developing web and mobile applications to exploring machine learning, I actively seek opportunities to expand my knowledge. This passion for technology, rooted in my early curiosity about computers, has made me an enthusiastic problem solver. I’m not afraid to dive deep into new challenges—whether it's writing programs in a new language or earning a certification in software development. This willingness to learn and adapt has been instrumental in my success."
        >
          <CanvasRevealEffect
            animationSpeed={3}
